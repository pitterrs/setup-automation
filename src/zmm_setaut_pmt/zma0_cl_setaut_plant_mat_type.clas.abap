CLASS zma0_cl_setaut_plant_mat_type DEFINITION
  PUBLIC FINAL CREATE PUBLIC .

  PUBLIC SECTION.

    TYPES: tty_plant_mat_type TYPE TABLE OF zma0v_setaut_pmt
           WITH DEFAULT KEY.
  ...
  PRIVATE SECTION.
    ...
    DATA database TYPE REF TO lcl_plant_mat_type_dao.
...
CLASS zma0_cl_setaut_plant_mat_type IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    DATA(lr_database) = NEW lcl_plant_mat_type_dao(
  ...
  METHOD get_registers_to_be_copied.
    ...
    re_result = me->database->get_rel_plant_mat_type( ).
  ...
  METHOD zma0_if_setaut_process~execute.
    ...
    lr_batch_input->fill_bdcdata(
      EXPORTING
        im_plant_mat_types   = me->reference_data
